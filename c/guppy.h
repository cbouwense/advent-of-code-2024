...
GupArrayInt    gup_array_int_remove_at_index(GupArrayInt xs, int index);
GupArrayInt    gup_array_int_remove_at_index_arena(GupArena *a, GupArrayInt xs, int index);
...
GupArrayString gup_array_string_remove_at_index(GupArrayString xs, int index);
GupArrayString gup_array_string_remove_at_index_arena(GupArena *a, GupArrayString xs, int index);
...
// GupArrayInt gup_array_int_remove_at_index_arena(GupArena *a, GupArrayInt xs, int index) {
//     GupArrayInt new_array = gup_array_int_create_arena(a);
...
GupArrayString gup_array_string_remove_at_index_arena(GupArena *a, GupArrayString xs, int index) {
    GupArrayString new_array = gup_array_string_create_arena(a);

    for (int i = 0; i < xs.count; i++) {
        if (i == index) continue;

        gup_array_string_append_arena(a, &new_array, xs.data[i]);
    }
